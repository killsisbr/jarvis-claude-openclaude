...
import { trySmartRoute, reportOutcome, type SmartRouteResult } from './services/api/smartRoutingBridge.js'
import type { SmartRoutingConfig } from './services/api/smartModelRouting.js'
import type { AgentModelsMap } from './services/api/providerResolver.js'
/* eslint-disable @typescript-eslint/no-require-imports */
